...
Display_fields = ["id", 
"Tree_code", "created", "updated","common_name", "scientific_name", 
"Age","Height","Diameter_girth",
"closest_address","Longitude",
"Latitude","specie_code","condition"]

Editable_fields = ["Tree_code", "common_name","scientific_name",
"Age","Height","Diameter_girth",
"closest_address","Longitude",
"Latitude","specie_code","condition"  ]
